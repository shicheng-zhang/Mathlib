#!/usr/bin/env python3
"""
06_redteam_p1_1_simd_batch_scalar_fallback.py
...
This script applies Red Team P2 item P1-1:
...
Usage:
    ...
    python3 06_redteam_p1_1_simd_batch_scalar_fallback.py

Force overwrite:

    python3 06_redteam_p1_1_simd_batch_scalar_fallback.py --force
"""
...
static inline void ml_simd_batch_rsqrt(const double* in, double* out) {
     ...
     *
     * MATHLIB_REDP2_P1_1:
     * Exceptional fallback now uses ml_fast_rsqrt() per lane so batch
     * semantics match the scalar fast-math contract exactly:
     *
     *   NaN             -> NaN
     *   negative finite -> NaN
     *   +inf            -> +0
...
NEW_TEST_P1_1 = r"""/* MATHLIB_REDP2_P1_1_TEST */
...
def patch_simd_batch(v11s: Path, force: bool) -> None:
